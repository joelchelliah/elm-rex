...
var _joelchelliah$elm_rex$WindowSize$Model = F2(
	function (a, b) {
		return {width: a, height: b};
	});
var _joelchelliah$elm_rex$WindowSize$size = A2(_joelchelliah$elm_rex$WindowSize$Model, 1000, 400);
var _joelchelliah$elm_rex$WindowSize$windowHeight = _joelchelliah$elm_rex$WindowSize$size.height;
var _joelchelliah$elm_rex$WindowSize$windowWidth = _joelchelliah$elm_rex$WindowSize$size.width;

var _joelchelliah$elm_rex$Background$groundRowPositions = function () {
	var nextLine = function (h) {
		return (_elm_lang$core$Native_Utils.cmp(h, 0) < 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(h - 10);
	};
	return A2(_elm_community$list_extra$List_Extra$iterate, nextLine, 88);
}();
var _joelchelliah$elm_rex$Background$skyRowPositions = function () {
	var nextLine = function (h) {
		return (_elm_lang$core$Native_Utils.cmp(h, 90) < 0) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(h - 15);
	};
	return A2(_elm_community$list_extra$List_Extra$iterate, nextLine, _joelchelliah$elm_rex$WindowSize$windowHeight);
}();
var _joelchelliah$elm_rex$Background$groundRowColors = {
	ctor: '::',
	_0: '#D9A066',
	_1: {
		ctor: '::',
...
var _joelchelliah$elm_rex$Background$fillRow = F3(
	function (alpha, col, yPos) {
		return A2(
				...
				_1: {
					...
					_1: {
						...
						_0: _elm_lang$svg$Svg_Attributes$y(
							_elm_lang$core$Basics$toString(_joelchelliah$elm_rex$WindowSize$windowHeight - yPos)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$width(
								_elm_lang$core$Basics$toString(_joelchelliah$elm_rex$WindowSize$windowWidth)),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$svg$Svg_Attributes$opacity(alpha),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _joelchelliah$elm_rex$Background$renderGround = function () {
	var fillGroundRow = _joelchelliah$elm_rex$Background$fillRow('1.0');
	var outline = A2(fillGroundRow, '#EEC39A', 90);
	var makeRow = A2(_elm_lang$core$List$map, fillGroundRow, _joelchelliah$elm_rex$Background$groundRowColors);
	var rows = A3(_elm_lang$core$List$map2, _elm_lang$core$Basics$identity, makeRow, _joelchelliah$elm_rex$Background$groundRowPositions);
	return A2(
		_elm_lang$svg$Svg$svg,
		{ctor: '[]'},
		{ctor: '::', _0: outline, _1: rows});
}();
var _joelchelliah$elm_rex$Background$renderSky = function () {
	var fillSkyRow = A2(_joelchelliah$elm_rex$Background$fillRow, '0.08', '#4575FF');
	var rows = A2(_elm_lang$core$List$map, fillSkyRow, _joelchelliah$elm_rex$Background$skyRowPositions);
	return A2(
		_elm_lang$svg$Svg$svg,
		{ctor: '[]'},
		rows);
}();
var _joelchelliah$elm_rex$Background$view = A2(
	_elm_lang$svg$Svg$svg,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _joelchelliah$elm_rex$Background$renderSky,
		_1: {
			ctor: '::',
			_0: _joelchelliah$elm_rex$Background$renderGround,
			_1: {ctor: '[]'}
		}
	});

var _joelchelliah$elm_rex$Cactus$bounds = function (cactus) {
	var offsetFromBottomEdge = 100;
	var _p0 = {ctor: '_Tuple2', _0: cactus.xPos, _1: (_joelchelliah$elm_rex$WindowSize$windowHeight - offsetFromBottomEdge) + cactus.yPos};
	var offsetX = _p0._0;
	var offsetY = _p0._1;
	return {exMin: offsetX, exMax: offsetX + cactus.width, eyMin: offsetY - cactus.height, eyMax: offsetY};
};
var _joelchelliah$elm_rex$Cactus$isVisible = function (cactus) {
	return _elm_lang$core$Native_Utils.cmp(cactus.xPos, 0 - cactus.width) > -1;
};
var _joelchelliah$elm_rex$Cactus$view = function (cactus) {
	var _p1 = _joelchelliah$elm_rex$Cactus$bounds(cactus);
	var exMin = _p1.exMin;
	var eyMin = _p1.eyMin;
	return A2(
		_elm_lang$svg$Svg$image,
		{
			...
			_0: _elm_lang$svg$Svg_Attributes$x(
				_elm_lang$core$Basics$toString(exMin)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y(
					_elm_lang$core$Basics$toString(eyMin)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(cactus.width)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$height(
							_elm_lang$core$Basics$toString(cactus.height)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$xlinkHref(cactus.img),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _joelchelliah$elm_rex$Cactus$update = F2(
	function (delta, cactus) {
		return _elm_lang$core$Native_Utils.update(
			cactus,
			{xPos: cactus.xPos - (cactus.speed * delta)});
	});
var _joelchelliah$elm_rex$Cactus$init = F3(
	function (x, i, speedInc) {
		return {
			xPos: x,
			yPos: 42,
			speed: 0.4 + (2.0e-2 * speedInc),
			width: 64,
			height: 84,
			img: A2(
				_elm_lang$core$Basics_ops['++'],
...
var _joelchelliah$elm_rex$CactusGenerator$maxCactusIndex = 5;
var _joelchelliah$elm_rex$CactusGenerator$getSpawnTime = F2(
	function (index, inc) {
		var indices = A2(_elm_lang$core$List$range, 0, _joelchelliah$elm_rex$CactusGenerator$maxCactusIndex);
		var timeDec = _elm_lang$core$Basics$floor(inc * 1.8);
		var withSpawnTime = function (i) {
			return {ctor: '_Tuple2', _0: i, _1: (45 + (6 * i)) - timeDec};
		};
		return function (_p0) {
			return A2(
				_elm_lang$core$Maybe$withDefault,
				...
				A2(
					...
					index,
					_elm_lang$core$Dict$fromList(
						A2(_elm_lang$core$List$map, withSpawnTime, _p0))));
		}(indices);
	});
var _joelchelliah$elm_rex$CactusGenerator$generateIndex = _elm_lang$core$Random$step(
	A2(_elm_lang$core$Random$int, 0, _joelchelliah$elm_rex$CactusGenerator$maxCactusIndex));
var _joelchelliah$elm_rex$CactusGenerator$generateCactusAt = F2(
	function (position, seed0) {
		var _p1 = _joelchelliah$elm_rex$CactusGenerator$generateIndex(seed0);
		var i = _p1._0;
		var seed1 = _p1._1;
		return {
			ctor: '_Tuple2',
			_0: A3(_joelchelliah$elm_rex$Cactus$init, position, i, 0),
			_1: seed1
		};
	});
var _joelchelliah$elm_rex$CactusGenerator$update = F3(
	function (delta, score, _p2) {
		var _p3 = _p2;
		var _p6 = _p3.spawnTimer;
		var _p5 = _p3;
		var updatedCacti = A2(
			_elm_lang$core$List$map,
			_joelchelliah$elm_rex$Cactus$update(delta),
			A2(_elm_lang$core$List$filter, _joelchelliah$elm_rex$Cactus$isVisible, _p3.cacti));
		var speedInc = _elm_lang$core$Basics$toFloat((score / 500) | 0);
		var _p4 = _joelchelliah$elm_rex$CactusGenerator$generateIndex(_p3.seed);
		var i = _p4._0;
		var nextSeed = _p4._1;
		return _elm_lang$core$Native_Utils.eq(_p6, 0) ? _elm_lang$core$Native_Utils.update(
			_p5,
			{
				cacti: {
					ctor: '::',
					_0: A3(_joelchelliah$elm_rex$Cactus$init, _joelchelliah$elm_rex$WindowSize$windowWidth, i, speedInc),
					_1: updatedCacti
				},
				seed: nextSeed,
				spawnTimer: A2(_joelchelliah$elm_rex$CactusGenerator$getSpawnTime, i, speedInc)
			}) : _elm_lang$core$Native_Utils.update(
			_p5,
			{cacti: updatedCacti, seed: nextSeed, spawnTimer: _p6 - 1});
	});
var _joelchelliah$elm_rex$CactusGenerator$init = function (seed0) {
	var startPosition = _joelchelliah$elm_rex$WindowSize$windowWidth - 200;
	var _p7 = A2(_joelchelliah$elm_rex$CactusGenerator$generateCactusAt, startPosition, seed0);
	var cactus = _p7._0;
	var seed1 = _p7._1;
	return {
		seed: seed1,
...
var _joelchelliah$elm_rex$CactusGenerator$Model = F3(
	function (a, b, c) {
		return {seed: a, cacti: b, spawnTimer: c};
	});

var _joelchelliah$elm_rex$Cloud$size = {width: 152, height: 84};
var _joelchelliah$elm_rex$Cloud$view = function (cloud) {
	return A2(
		_elm_lang$svg$Svg$image,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$x(
				_elm_lang$core$Basics$toString(cloud.xPos)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y(
				...
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
						_elm_lang$core$Basics$toString(_joelchelliah$elm_rex$Cloud$size.width)),
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$height(
							_elm_lang$core$Basics$toString(_joelchelliah$elm_rex$Cloud$size.height)),
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$opacity('0.3'),
							_1: {
								ctor: '::',
								_0: _elm_lang$svg$Svg_Attributes$xlinkHref('images/clouds/cloud_0.png'),
								_1: {ctor: '[]'}
							}
						}
					}
...
var _joelchelliah$elm_rex$Cloud$update = F2(
	function (delta, _p0) {
		var _p1 = _p0;
		var _p5 = _p1.xPos;
		var _p4 = _p1.speed;
		var _p3 = _p1;
		var _p2 = {ctor: '_Tuple2', _0: 0, _1: _joelchelliah$elm_rex$WindowSize$windowWidth - _joelchelliah$elm_rex$Cloud$size.width};
		var leftEdge = _p2._0;
		var rightEdge = _p2._1;
		return (_elm_lang$core$Native_Utils.cmp(_p5, leftEdge) < 0) ? _elm_lang$core$Native_Utils.update(
			_p3,
			{xPos: leftEdge, speed: 0 - _p4}) : ((_elm_lang$core$Native_Utils.cmp(_p5, rightEdge) > 0) ? _elm_lang$core$Native_Utils.update(
			_p3,
			{xPos: rightEdge, speed: 0 - _p4}) : _elm_lang$core$Native_Utils.update(
			_p3,
			{xPos: _p3.xPos - (_p3.speed * delta)}));
	});
var _joelchelliah$elm_rex$Cloud$init = {xPos: 700, speed: 2.0e-2};
var _joelchelliah$elm_rex$Cloud$Model = F2(
	function (a, b) {
		return {xPos: a, speed: b};
	});

var _joelchelliah$elm_rex$Hud$Model = F3(
	function (a, b, c) {
		return {score: a, highScore: b, state: c};
	});
var _joelchelliah$elm_rex$Hud$Highlighted = {ctor: 'Highlighted'};
var _joelchelliah$elm_rex$Hud$highlightStyles = function (state) {
	return _elm_lang$core$Native_Utils.eq(state, _joelchelliah$elm_rex$Hud$Highlighted) ? {ctor: '_Tuple2', _0: 'red', _1: '0.85'} : {ctor: '_Tuple2', _0: 'black', _1: '0.6'};
};
var _joelchelliah$elm_rex$Hud$renderOutline = function (_p0) {
	var _p1 = _p0;
	var _p2 = _joelchelliah$elm_rex$Hud$highlightStyles(_p1.state);
	var col = _p2._0;
	var alpha = _p2._1;
	return A2(
		_elm_lang$svg$Svg$rect,
			...
			_0: _elm_lang$svg$Svg_Attributes$style(
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						col,
						A2(_elm_lang$core$Basics_ops['++'], ';stroke-width:5;opacity:', alpha)))),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$x('0'),
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$svg$Svg_Attributes$height(
								_elm_lang$core$Basics$toString(_joelchelliah$elm_rex$WindowSize$windowHeight)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _joelchelliah$elm_rex$Hud$renderScore = function (_p3) {
	var _p4 = _p3;
	var _p5 = _joelchelliah$elm_rex$Hud$highlightStyles(_p4.state);
	var col = _p5._0;
	var alpha = _p5._1;
	var attrs = {
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$svg$Svg_Attributes$fontSize('25'),
						_1: {
							ctor: '::',
		...
		attrs,
		{
			...
			_0: _elm_lang$svg$Svg$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Score: ',
					_elm_lang$core$Basics$toString(_p4.score))),
			_1: {ctor: '[]'}
		});
};
var _joelchelliah$elm_rex$Hud$renderHighScore = function (_p6) {
	var _p7 = _p6;
	var _p8 = _joelchelliah$elm_rex$Hud$highlightStyles(_p7.state);
	var col = _p8._0;
	var alpha = _p8._1;
	var attrs = {
		ctor: '::',
		_0: _elm_lang$svg$Svg_Attributes$x('980'),
		_1: {
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$y('40'),
			_1: {
		...
		attrs,
		{
			...
			_0: _elm_lang$svg$Svg$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'High Score: ',
					_elm_lang$core$Basics$toString(_p7.highScore))),
			_1: {ctor: '[]'}
		});
};
var _joelchelliah$elm_rex$Hud$view = function (hud) {
	return A2(
		_elm_lang$svg$Svg$svg,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _joelchelliah$elm_rex$Hud$renderOutline(hud),
			_1: {
				ctor: '::',
				_0: _joelchelliah$elm_rex$Hud$renderScore(hud),
				_1: {
					ctor: '::',
					_0: _joelchelliah$elm_rex$Hud$renderHighScore(hud),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _joelchelliah$elm_rex$Hud$Normal = {ctor: 'Normal'};
var _joelchelliah$elm_rex$Hud$init = {score: 0, highScore: 0, state: _joelchelliah$elm_rex$Hud$Normal};
var _joelchelliah$elm_rex$Hud$update = F2(
	function (msg, _p9) {
		var _p10 = _p9;
		var _p14 = _p10.score;
		var _p13 = _p10;
		var _p12 = _p10.highScore;
		var _p11 = msg;
		switch (_p11.ctor) {
			case 'IncScore':
				return _elm_lang$core$Native_Utils.update(
			...
			case 'Reset':
				return _elm_lang$core$Native_Utils.update(
					_p13,
					{score: 0, state: _joelchelliah$elm_rex$Hud$Normal});
			default:
				var newHighScore = (_elm_lang$core$Native_Utils.cmp(_p14, _p12) > 0) ? _p14 : _p12;
				return _elm_lang$core$Native_Utils.update(
					_p13,
					{highScore: newHighScore, state: _joelchelliah$elm_rex$Hud$Highlighted});
		}
	});
var _joelchelliah$elm_rex$Hud$Highlight = {ctor: 'Highlight'};
var _joelchelliah$elm_rex$Hud$Reset = {ctor: 'Reset'};
var _joelchelliah$elm_rex$Hud$IncScore = {ctor: 'IncScore'};

var _joelchelliah$elm_rex$Rex$offsetFromBottomEdge = 60;
var _joelchelliah$elm_rex$Rex$offsetFromLeftEdge = 50;
var _joelchelliah$elm_rex$Rex$bounds = function (rex) {
	var _p0 = {ctor: '_Tuple2', _0: _joelchelliah$elm_rex$Rex$offsetFromLeftEdge, _1: (_joelchelliah$elm_rex$WindowSize$windowHeight - _joelchelliah$elm_rex$Rex$offsetFromBottomEdge) + rex.yPos};
	var offsetX = _p0._0;
	var offsetY = _p0._1;
	return {xMin: offsetX, xMax: offsetX + rex.width, yMin: offsetY - rex.height, yMax: offsetY};
};
var _joelchelliah$elm_rex$Rex$sizeDucking = {width: 108, height: 60};
var _joelchelliah$elm_rex$Rex$sizeRunning = {width: 92, height: 84};
var _joelchelliah$elm_rex$Rex$render = function (_p1) {
	var _p2 = _p1;
	...
	var airbourneIndex = _elm_lang$core$Basics$toString(
		(_elm_lang$core$Native_Utils.cmp(_p2.yVel, 0.2) < 0) ? 0 : 1);
	var runningIndex = _elm_lang$core$Basics$toString(
		A2(_elm_lang$core$Basics_ops['%'], _p2.runCount, 6));
	var _p3 = _p2.state;
	switch (_p3.ctor) {
		case 'Idle':
			return toImg('idle');
		case 'Running':
			return toImg(
				A2(_elm_lang$core$Basics_ops['++'], 'run_', runningIndex));
		case 'Jumping':
			return toImg(
				A2(_elm_lang$core$Basics_ops['++'], 'jump_', airbourneIndex));
		case 'Ducking':
			return toImg(
				A2(_elm_lang$core$Basics_ops['++'], 'duck_', runningIndex));
		default:
			return toImg(
				A2(_elm_lang$core$Basics_ops['++'], 'dead_', airbourneIndex));
	}
};
var _joelchelliah$elm_rex$Rex$view = function (rex) {
	var _p4 = _joelchelliah$elm_rex$Rex$bounds(rex);
	var xMin = _p4.xMin;
	var yMin = _p4.yMin;
	return A2(
		_elm_lang$svg$Svg$image,
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$x(
				_elm_lang$core$Basics$toString(xMin)),
			_1: {
				ctor: '::',
				_0: _elm_lang$svg$Svg_Attributes$y(
					_elm_lang$core$Basics$toString(yMin)),
				_1: {
					ctor: '::',
					_0: _elm_lang$svg$Svg_Attributes$width(
...
var _joelchelliah$elm_rex$Rex$animate = F2(
	function (state, _p5) {
		var _p6 = _p5;
		var _p8 = _p6.frameInc;
		var size = function () {
			var _p7 = state;
			switch (_p7.ctor) {
				case 'Ducking':
					return _joelchelliah$elm_rex$Rex$sizeDucking;
				case 'Dead':
					return _joelchelliah$elm_rex$Rex$sizeDucking;
				default:
					return _joelchelliah$elm_rex$Rex$sizeRunning;
			}
		}();
		return _elm_lang$core$Native_Utils.update(
			_p6,
			{state: state, width: size.width, height: size.height, runCount: _p6.runCount + _p8, frameInc: 1 - _p8});
	});
var _joelchelliah$elm_rex$Rex$initJump = F2(
	function (force, rex) {
		return _elm_lang$core$Native_Utils.update(
			rex,
			{yPos: 0 - force, yVel: 0 - force});
	});
var _joelchelliah$elm_rex$Rex$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {state: a, yPos: b, yVel: c, width: d, height: e, runCount: f, frameInc: g};
	});
...
var _joelchelliah$elm_rex$Rex$hasLandedFromJumping = function (rex) {
	return (_elm_lang$core$Native_Utils.cmp(rex.yPos, 0) > -1) && _elm_lang$core$Native_Utils.eq(rex.state, _joelchelliah$elm_rex$Rex$Jumping);
};
var _joelchelliah$elm_rex$Rex$hitDetected = F2(
	function (rex, obstacles) {
		hitDetected:
		while (true) {
			var _p9 = obstacles;
			if (_p9.ctor === '[]') {
				...
				var eyMax = _p11.eyMax;
				var _p12 = _joelchelliah$elm_rex$Rex$bounds(rex);
				var xMin = _p12.xMin;
				var xMax = _p12.xMax;
				var yMin = _p12.yMin;
				var yMax = _p12.yMax;
				var xInBounds = (_elm_lang$core$Native_Utils.cmp(margin, xMax - exMin) < 0) && (_elm_lang$core$Native_Utils.cmp(marginAfter, exMax - xMin) < 0);
				var yInBounds = (_elm_lang$core$Native_Utils.cmp(margin, yMax - eyMin) < 0) && (_elm_lang$core$Native_Utils.cmp(margin, eyMax - yMin) < 0);
				if (xInBounds && yInBounds) {
					...
					rex = _v5;
					obstacles = _v6;
					continue hitDetected;
				}
			}
		}
	});
var _joelchelliah$elm_rex$Rex$Running = {ctor: 'Running'};
var _joelchelliah$elm_rex$Rex$updateAirbourne = F2(
	function (delta, _p13) {
		var _p14 = _p13;
		var _p17 = _p14.yVel;
		var _p16 = _p14;
		var gravity = 5.0e-3;
		var _p15 = _joelchelliah$elm_rex$Rex$hasLandedFromJumping(_p16) ? {ctor: '_Tuple3', _0: _joelchelliah$elm_rex$Rex$Running, _1: 0, _2: 0} : {ctor: '_Tuple3', _0: _p14.state, _1: _p14.yPos + (_p17 * delta), _2: _p17 + (gravity * delta)};
		var state_ = _p15._0;
		var yPos_ = _p15._1;
		var yVel_ = _p15._2;
		return _elm_lang$core$Native_Utils.update(
			_p16,
			{yPos: yPos_, yVel: yVel_, state: state_});
	});
	...
	function (msg, model) {
		...
		switch (_p18.ctor) {
			case 'Run':
				...
				if (_p19.ctor === 'Jumping') {
					return model;
				} else {
					return A2(_joelchelliah$elm_rex$Rex$animate, _joelchelliah$elm_rex$Rex$Running, model);
				}
			case 'Jump':
				var _p20 = model.state;
				if (_p20.ctor === 'Jumping') {
					return model;
				} else {
					return A2(
						_joelchelliah$elm_rex$Rex$initJump,
						1.3,
						A2(_joelchelliah$elm_rex$Rex$animate, _joelchelliah$elm_rex$Rex$Jumping, model));
				}
			case 'Duck':
				var _p21 = model.state;
				if (_p21.ctor === 'Jumping') {
					return model;
				} else {
					return A2(_joelchelliah$elm_rex$Rex$animate, _joelchelliah$elm_rex$Rex$Ducking, model);
				}
			case 'Kill':
				return A2(
					_joelchelliah$elm_rex$Rex$initJump,
					0.7,
					A2(_joelchelliah$elm_rex$Rex$animate, _joelchelliah$elm_rex$Rex$Dead, model));
			default:
				var _p23 = _p18._0;
				var _p22 = model.state;
				switch (_p22.ctor) {
					case 'Jumping':
						return A2(_joelchelliah$elm_rex$Rex$updateAirbourne, _p23, model);
					case 'Dead':
						return A2(_joelchelliah$elm_rex$Rex$updateAirbourne, _p23, model);
					case 'Running':
						return A2(_joelchelliah$elm_rex$Rex$animate, _joelchelliah$elm_rex$Rex$Running, model);
...
var _joelchelliah$elm_rex$Rex$init = {state: _joelchelliah$elm_rex$Rex$Idle, yPos: 0, yVel: 0, width: _joelchelliah$elm_rex$Rex$sizeRunning.width, height: _joelchelliah$elm_rex$Rex$sizeRunning.height, runCount: 1, frameInc: 0};
...
var _joelchelliah$elm_rex$Game$nextSeed = function (seed) {
	return _elm_lang$core$Tuple$second(
...
var _joelchelliah$elm_rex$Game$Model = F6(
	function (a, b, c, d, e, f) {
		return {state: a, hud: b, rex: c, cactusGen: d, cloud: e, seed: f};
	});
...
var _joelchelliah$elm_rex$Game$init = function (seed) {
	return {
		...
		cactusGen: _joelchelliah$elm_rex$CactusGenerator$init(seed),
		cloud: _joelchelliah$elm_rex$Cloud$init,
		seed: _joelchelliah$elm_rex$Game$nextSeed(seed)
	};
};
var _joelchelliah$elm_rex$Game$restart = function (game) {
	return {
		state: _joelchelliah$elm_rex$Game$New,
		hud: A2(_joelchelliah$elm_rex$Hud$update, _joelchelliah$elm_rex$Hud$Reset, game.hud),
		rex: _joelchelliah$elm_rex$Rex$init,
		cactusGen: _joelchelliah$elm_rex$CactusGenerator$init(game.seed),
		cloud: game.cloud,
		seed: _joelchelliah$elm_rex$Game$nextSeed(game.seed)
	};
};
...
var _joelchelliah$elm_rex$Game$viewCloud = function (cloud) {
	return A2(
		_elm_lang$html$Html$map,
		function (_p7) {
			return _joelchelliah$elm_rex$Game$SubMsg;
		},
		_joelchelliah$elm_rex$Cloud$view(cloud));
};
...
var _joelchelliah$elm_rex$Game$view = function (_p10) {
	var _p11 = _p10;
	var _p13 = _p11.hud;
	var sceneElements = {
		ctor: '::',
		...
		_1: {
			ctor: '::',
			_0: _joelchelliah$elm_rex$Game$viewCacti(_p11.cactusGen.cacti),
			_1: {
				ctor: '::',
				_0: _joelchelliah$elm_rex$Game$viewCloud(_p11.cloud),
				_1: {
					ctor: '::',
					_0: _joelchelliah$elm_rex$Game$viewRex(_p11.rex),
					_1: {
						ctor: '::',
						_0: A2(_joelchelliah$elm_rex$Game$viewAlert, _p11.state, _p13.score),
						_1: {
							ctor: '::',
							_0: _joelchelliah$elm_rex$Game$viewHud(_p13),
							_1: {ctor: '[]'}
						}
					}
				}
					...
					return _elm_lang$core$Native_Utils.update(
						_p20,
						{
							rex: A2(
								...
								_joelchelliah$elm_rex$Game$codeToRexMsg(_p16._0),
								_p22)
						});
				case 'KeyReleased':
					return _elm_lang$core$Native_Utils.update(
						_p20,
						{
							rex: A2(_joelchelliah$elm_rex$Rex$update, _joelchelliah$elm_rex$Rex$Run, _p22)
						});
				case 'Tick':
					var _p17 = _p16._0;
					return A2(_joelchelliah$elm_rex$Rex$hitDetected, _p22, _p18.cacti) ? _elm_lang$core$Native_Utils.update(
						_p20,
						{
							...
							rex: A2(_joelchelliah$elm_rex$Rex$update, _joelchelliah$elm_rex$Rex$Kill, _p22),
							cloud: A2(_joelchelliah$elm_rex$Cloud$update, _p17, _p19)
						}) : _elm_lang$core$Native_Utils.update(
						_p20,
						{
							rex: A2(
								_joelchelliah$elm_rex$Rex$update,
								_joelchelliah$elm_rex$Rex$Tick(_p17),
								_p22),
							cactusGen: A3(_joelchelliah$elm_rex$CactusGenerator$update, _p17, _p21.score, _p18),
							cloud: A2(_joelchelliah$elm_rex$Cloud$update, _p17, _p19),
							hud: _joelchelliah$elm_rex$Rex$hasLandedFromJumping(_p22) ? A2(_joelchelliah$elm_rex$Hud$update, _joelchelliah$elm_rex$Hud$IncScore, _p21) : _p21
						});
				default:
					return _p20;
			}
...
var _joelchelliah$elm_rex$Game$updatePaused = F2(
	function (msg, game) {
		return _joelchelliah$elm_rex$Game$spacePressed(msg) ? _elm_lang$core$Native_Utils.update(
			game,
			{state: _joelchelliah$elm_rex$Game$Playing}) : game;
	});
var _joelchelliah$elm_rex$Game$updateGameOver = F2(
	function (msg, game) {
		if (_joelchelliah$elm_rex$Game$spacePressed(msg)) {
			return _joelchelliah$elm_rex$Game$restart(game);
		} else {
			var _p23 = msg;
			if (_p23.ctor === 'Tick') {
				var _p24 = _p23._0;
				return _elm_lang$core$Native_Utils.update(
					game,
					{
						rex: A2(
							_joelchelliah$elm_rex$Rex$update,
							_joelchelliah$elm_rex$Rex$Tick(_p24),
							game.rex),
						cloud: A2(_joelchelliah$elm_rex$Cloud$update, _p24, game.cloud)
					});
			} else {
				return game;
			}
...
var _joelchelliah$elm_rex$Game$update = F2(
	function (msg, game) {
		...
		switch (_p25.ctor) {
			case 'Playing':
				return A2(_joelchelliah$elm_rex$Game$updatePlaying, msg, game);
			case 'GameOver':
				return A2(_joelchelliah$elm_rex$Game$updateGameOver, msg, game);
			default:
				return A2(_joelchelliah$elm_rex$Game$updatePaused, msg, game);
		}
	});
var _joelchelliah$elm_rex$Game$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _joelchelliah$elm_rex$Game$subscriptions = function (_p26) {
...
var _joelchelliah$elm_rex$Main$viewInfo = function () {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$svg$Svg_Attributes$class('info'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Find it on github'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$src('images/logo_right.png'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {
					ctor: '::',
					_0: _elm_lang$html$Html$text('ELM-REX'),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$img,
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$src('images/logo_left.png'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('- An Elm port of Chrome\'s T-rex runner game -'),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		}
...
var _joelchelliah$elm_rex$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _joelchelliah$elm_rex$Main$init, view: _joelchelliah$elm_rex$Main$view, update: _joelchelliah$elm_rex$Main$update, subscriptions: _joelchelliah$elm_rex$Main$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (randomSeed) {
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _joelchelliah$elm_rex$Main$main !== 'undefined') {
    _joelchelliah$elm_rex$Main$main(Elm['Main'], 'Main', undefined);
}
