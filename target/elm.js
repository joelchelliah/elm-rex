...
var _joelchelliah$elm_rex$Rex$view = F2(
	function (_p3, rex) {
		var _p4 = _p3;
		var y$ = _elm_lang$core$Basics$toString(_p4._1 - 110);
...
var _joelchelliah$elm_rex$Rex$fall = F3(
	function (delta, y, vy) {
		return {ctor: '_Tuple2', _0: y + (vy * delta), _1: vy};
	});
var _joelchelliah$elm_rex$Rex$fly = F3(
	function (delta, y, vy) {
		return {ctor: '_Tuple2', _0: y + (vy * delta), _1: vy};
	});
...
var _joelchelliah$elm_rex$Rex$move = F2(
	function (delta, _p5) {
		...
		var _p9 = _p6.yVel;
		var _p8 = _p6.yPos;
		var _p7 = (_elm_lang$core$Native_Utils.cmp(_p8, 0) > -1) ? {ctor: '_Tuple3', _0: _joelchelliah$elm_rex$Rex$Running, _1: 0, _2: 0} : {ctor: '_Tuple3', _0: _joelchelliah$elm_rex$Rex$Jumping, _1: _p8 + (_p9 * delta), _2: _p9};
		var state$ = _p7._0;
		var yPos$ = _p7._1;
		var yVel$ = _p7._2;
...
var _joelchelliah$elm_rex$Rex$update = F2(
	function (msg, model) {
		...
		switch (_p10.ctor) {
			case 'Run':
				return _elm_lang$core$Native_Utils.eq(model.state, _joelchelliah$elm_rex$Rex$Jumping) ? model : _elm_lang$core$Native_Utils.update(
					model,
					{state: _joelchelliah$elm_rex$Rex$Running});
			case 'Jump':
				return _elm_lang$core$Native_Utils.update(
					model,
					{state: _joelchelliah$elm_rex$Rex$Jumping});
			case 'Duck':
				return _elm_lang$core$Native_Utils.update(
					model,
			...
			case 'Kill':
				return model;
			default:
				return A2(_joelchelliah$elm_rex$Rex$move, _p10._0, model);
		}
	});
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							rex: A2(
								...
								_joelchelliah$elm_rex$Main$codeToMsg(_p6._0),
								model.rex)
						}),
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							rex: A2(
								_joelchelliah$elm_rex$Rex$update,
								_joelchelliah$elm_rex$Rex$Tick(_p6._0),
								model.rex)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _joelchelliah$elm_rex$Main$Model = F3(
	function (a, b, c) {
		return {rex: a, obstacles: b, time: c};
	});
var _joelchelliah$elm_rex$Main$init = {
	ctor: '_Tuple2',
	_0: A3(
		_joelchelliah$elm_rex$Main$Model,
		_joelchelliah$elm_rex$Rex$init,
		_elm_lang$core$Native_List.fromArray(
			[]),
		0),
	_1: _elm_lang$core$Platform_Cmd$none
...
var _joelchelliah$elm_rex$Main$view = function (_p7) {
	var _p8 = _p7;
	var _p9 = {ctor: '_Tuple2', _0: 800, _1: 300};
	var w = _p9._0;
	var h = _p9._1;
	var windowSize = {ctor: '_Tuple2', _0: w, _1: h};
	var sceneElements = _elm_lang$core$Native_List.fromArray(
		[
			...
			A2(_joelchelliah$elm_rex$Rex$view, windowSize, _p8.rex))
		]);
...
var _joelchelliah$elm_rex$Main$subscriptions = function (_p11) {
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_elm_lang$core$Time$every, 1000, _joelchelliah$elm_rex$Main$Tick),
